...
async def get_knowledge_systems(db: CurrentSession) -> ResponseSchemaModel[PageData[GetKnowledgeSystemListItem]]:
    """获取可用知识体系（分页）"""
    stmt = knowledge_service.get_systems_select()
...
async def get_knowledge_tree(
    ...
    bank_id: Annotated[int, Query(gt=0, description='题库稳定身份 ID')],
