...
from backend.app.task.api.v1.resource_task import router as resource_task_router
...
v1.include_router(resource_task_router, prefix='/tasks/resource', tags=['资源任务'])
