...
@router.post('/sessions', summary='创建练习会话', name='qbank_practice_create_session')
...
@router.get('/sessions/{pk}', summary='获取练习会话详情', name='qbank_practice_get_session')
...
@router.get('/sessions/latest', summary='获取最新的进行中会话', name='qbank_practice_get_latest_session')
...
@router.put('/sessions/{pk}', summary='更新练习会话统计', name='qbank_practice_update_session')
...
@router.post('/sessions/{pk}/submit', summary='提交练习会话', name='qbank_practice_submit_session')
...
@router.post('/sessions/{pk}/abandon', summary='放弃练习会话', name='qbank_practice_abandon_session')
...
@router.get('/sessions/{pk}/records', summary='获取会话的所有答题记录', name='qbank_practice_get_session_records')
