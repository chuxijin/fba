...
@router.get('/{pk}', summary='获取官媒文章详情', response_model=ResponseSchemaModel[GetContentDetail])
...
@router.get('', summary='获取官媒文章列表', response_model=ResponseSchemaModel[list[GetContentListDetail]])
