...
class CreateTemplateParam(SchemaBase):
    ...
    tier_code: str | None = Field(default=None, max_length=32, description='商业会员档位编码')
...
class GetTemplateDetail(SchemaBase):
    ...
    tier_code: str | None = Field(default=None, description='商业会员档位编码')
    tier_name: str | None = Field(default=None, description='商业会员档位名称')
    tier_weight: int = Field(default=0, description='商业会员档位权重')
    is_paid_membership: bool = Field(default=False, description='是否属于付费会员')
