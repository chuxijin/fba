...
用法:
  .venv/Scripts/python -m backend.plugin.agents.scripts.test_ocr --image backend/plugin/agents/tests/33734e2b853489ad707a5a31f6b03db5.png
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(description='OCR e2e 测试')
