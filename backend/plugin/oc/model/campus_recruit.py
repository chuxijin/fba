...
class CampusRecruit(DataClassBase, DateTimeMixin):
    """校招岗位表"""

    __tablename__ = 'oc_campus_recruit'
    ...
    application_status: Mapped[str] = mapped_column(sa.String(32), default='未投递', comment='投递进度')
    ...
    exam_info: Mapped[str | None] = mapped_column(sa.String(500), default=None, comment='笔试信息')
