...
-- 查看触发器
-- SHOW TRIGGERS LIKE 'yp_resource';

-- 删除触发器（如果需要）
-- DROP TRIGGER IF EXISTS tr_resource_view_count_update;
-- DROP TRIGGER IF EXISTS tr_resource_view_count_insert; 