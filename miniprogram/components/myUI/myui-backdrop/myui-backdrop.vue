<template>
	<!-- #ifdef APP-NVUE -->
	<view ref="fui_bd_ani" class="myui-backdrop__wrap"
	...
	<!-- #endif -->
	<!-- #ifndef APP-NVUE -->
	<view class="myui-backdrop__wrap" :class="{'myui-backdrop__bg':!background,'myui-backdrop__show':show}"
...
<style scoped>
	...
	/* #ifndef APP-NVUE */
	.myui-backdrop__bg {
		background: var(--myui-bg-color-mask, rgba(0, 0, 0, 0.6)) !important;
	}
