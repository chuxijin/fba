<template>
	<view class="myui-wing__blank-wrap"
		:class="[radius?'myui-wing__blank-hidden':'',getPadding?'':`myui-wing__blank-${getSize}`]" :style="getStyles"
		@tap="handleClick">
		<slot></slot>
	</view>
</template>
...
<style scoped>
	...
	.myui-wing__blank-hidden {
		overflow: hidden;
	}

	.myui-wing__blank-small {
		padding: 0 16rpx;
	}

	.myui-wing__blank-default {
		padding: 0 24rpx;
	}

	.myui-wing__blank-large {
		padding: 0 32rpx;
	}
</style>