<template>
	<text class="myui-digitalnumbers"
		:class="{'myui-number__highlight':!disabled && highlight,'myui-number__color':!color || color===true}"
