<template>
	<view class="myui-grid__wrap" :class="[isShow?'myui-grid__wrap-show':'myui-grid__wrap-hidden']">
		<view :id="elemId" ref="fui_grid" class="myui-grid"
			:class="{ 'myui-grid__border': showBorder,'myui-grid__between':between }"
...
<style scoped>
	...
	.myui-grid__wrap-hidden {
		opacity: 0;
	}

	.myui-grid__wrap-show {
		opacity: 1 !important;
	}
