<template>
	<view class="myui-list__cell" :class="{'myui-highlight':highlight,'myui-list__cell-background':!background}"
		...
		<view v-if="topBorder" :style="{background:getBorderColor,left:topLeft+'rpx',right:topRight+'rpx'}"
			class="myui-cell__border-top" :class="{'myui-cell__border-color':!getBorderColor}"></view>
		<slot></slot>
		<view v-if="bottomBorder" :style="{background:getBorderColor,left:getBottomLeft+'rpx',right:bottomRight+'rpx'}"
			class="myui-cell__border-bottom" :class="{'myui-cell__border-color':!getBorderColor}"></view>
		<view class="myui-cell__arrow" v-if="arrow" :style="{'border-color':getArrowColor}">
		</view>
	</view>
</template>
...
<style scoped>
	...
	/* #ifndef APP-NVUE */
	.myui-cell__border-color {
		background-color: var(--myui-color-border, #EEEEEE) !important;
	}

	.myui-list__cell-background {
		background-color: var(--myui-bg-color, #fff);
	}

	/* #endif */
	.myui-highlight:active {
		/* #ifdef APP-NVUE */
