<template>
	<view class="myui-list__wrap" :style="{marginTop:marginTop+'rpx'}">
		<view class="myui-list__title"
		...
		<view class="myui-list__container">
			<view v-if="topBorder" :style="{background:borderColor,left:topLeft+'rpx',right:topRight+'rpx'}"
				class="myui-list__border-top" :class="{'myui-list__border-color':!borderColor}"></view>
			<slot></slot>
			<view v-if="bottomBorder" :style="{background:borderColor,left:bottomLeft+'rpx',right:bottomRight+'rpx'}"
				class="myui-list__border-bottom" :class="{'myui-list__border-color':!borderColor}"></view>
		</view>
		<view class="myui-list__footer"
