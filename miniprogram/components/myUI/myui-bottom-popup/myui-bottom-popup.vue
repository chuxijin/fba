<template>
	<view class="myui-bottom__popup-wrap" :class="{'myui-bottom__popwrap-show':show}"
		...
		<!-- #ifdef APP-NVUE -->
		<view class="myui-bottom__popup-border" :style="{height:radius+'rpx',background: background}" v-if="radius">
		</view>
		<!-- #endif -->
		<view ref="fui_bp_ani" class="myui-bottom__popup"
			:class="{ 'myui-bottom__popup-show': show,'myui-bp__safe-weex':iphoneX && safeArea}"
