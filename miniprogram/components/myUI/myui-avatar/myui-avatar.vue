<template>
	<view class="myui-avatar__wrap" :class="[width?'':'myui-avatar__size-'+size,radius===-1?'myui-avatar__'+shape:'']"
		:style="wrapStyles" @tap="handleClick">
		<image class="myui-avatar__img" :style="styles"
			:class="[radius===-1?'myui-avatar__'+shape:'',width?'':'myui-avatar__size-'+size]" :src="showImg" :mode="mode"
			v-if="src && src!==true" :webp="webp" :lazy-load="lazyLoad" @error="handleError"></image>
		<text class="myui-avatar__text" :class="[width?'':'myui-avatar__text-'+size]" v-if="!src && src!==true && text"
...
<style scoped>
	...
	.myui-avatar__size-small {
		width: 64rpx !important;
		height: 64rpx !important;

	}

	.myui-avatar__text-small {
		font-size: 32rpx !important;
	}

	.myui-avatar__size-middle {
		width: 96rpx !important;
		height: 96rpx !important;
	}

	.myui-avatar__text-middle {
		font-size: 44rpx !important;
	}

	.myui-avatar__size-large {
		width: 128rpx !important;
		height: 128rpx !important;
	}

	.myui-avatar__text-large {
