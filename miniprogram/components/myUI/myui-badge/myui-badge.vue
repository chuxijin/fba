<template>
	<text
		:class="[dot?'myui-badge__dot':'myui-badge__wrap',background?'':('myui-badge__bg-'+type),absolute?'myui-badge__absolute':'',scaleRatio!=1 && isNvue?'myui-badge__trans-origin':'',!background && type==='white'?'myui-badge__text-color':'']"
...
<style scoped>
	...
	.myui-badge__trans-origin {
		transform-origin: center center;
	}

	/* #endif */
	.myui-badge__absolute {
		position: absolute;
	}
</style>