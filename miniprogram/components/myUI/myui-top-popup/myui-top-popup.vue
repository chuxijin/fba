<template>
	<view class="myui-top__popup-wrap" :class="{'myui-top__popwrap-show':show}"
		...
		<view ref="fui_tp_ani" class="myui-top__popup" :class="{ 'myui-top__popup-show': show}"
