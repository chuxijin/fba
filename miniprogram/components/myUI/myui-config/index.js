...
/*
  ...
  目前支持配置的组件：myui-button、myui-icon、myui-text、myui-input、myui-form-item、myui-list-cell
  myui-section、myui-white-space、myui-wing-blank、myui-number
*/

// 主色（V1.9.8+），仅Nvue端以及无法使用css变量控制颜色的组件使用【保持与myui-theme中一致】
const color = {
	primary: '#465CFF',
	success: '#09BE4F',
	warning: '#FFB703',
