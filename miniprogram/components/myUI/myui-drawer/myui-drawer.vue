<template>
	<view class="myui-drawer__popup-wrap" :class="{'myui-drawer__wrap-show':show}"
		...
		<view ref="fui_dwr_ani" class="myui-drawer__popup" :class="['myui-drawer_'+direction,show?'myui-drawer__show':'']"
