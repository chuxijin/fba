<template>
	<view class="myui-sections__wrap"
		...
		<view class="myui-sections__title" @tap="handleClick">
			<view class="myui-sections__line" :class="{'myui-sections__line-color':!getLineColor}"
			...
			<slot></slot>
			<text class="myui-sections__title-text" :style="getTitleStyle" v-if="title">{{title}}</text>
			<slot name="right"></slot>
		</view>
		<view class="myui-sections__descr" :style="getDescrTop" v-if="descr">
			<text class="myui-sections__descr-text" :style="getDescrStyle">{{descr}}</text>
		</view>
...
<style scoped>
	...
	.myui-sections__descr {
		/* #ifndef APP-NVUE */
		word-break: break-all;
		/* #endif */
	}

	.myui-sections__descr-text {
		/* #ifndef APP-NVUE */
		word-break: break-all;
		/* #endif */
		font-weight: 400;
