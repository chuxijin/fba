...
<template>
  <view class="relative min-h-screen from-[#FEF2F2] via-[#FFF8F8] to-[#FAFAFA] bg-gradient-to-b text-[#334155]">
    <view class="relative z-10 w-full" :style="{ paddingTop: `${statusBarHeight}px` }">
      <view class="relative h-11 flex items-center justify-center px-4">
        ...
        <text class="text-lg text-[#1E293B] font-bold tracking-widest">我的错题</text>
      </view>
    </view>
