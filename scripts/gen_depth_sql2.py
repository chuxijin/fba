        ...
        {"id": 783918, "name": "数量关系", "children": [
            {"id": 784242, "name": "数学运算", "children": [
                ...
                {"id": 784246, "name": "周期问题", "children": [
                    {"id": 784266, "name": "周期相遇问题"}, {"id": 784267, "name": "周期余数问题"}, {"id": 784268, "name": "周期问题-其他"}]},
                ...
                {"id": 784251, "name": "容斥原理问题", "children": [{"id": 784277, "name": "两集合"}, {"id": 784278, "name": "三集合"}]},
                ...
                {"id": 784253, "name": "概率问题", "children": [
                    {"id": 784286, "name": "给情况求概率"}, {"id": 784287, "name": "给概率求概率"}, {"id": 784288, "name": "概率问题-其他"}]},
        ...
        {"id": 783919, "name": "判断推理", "children": [
            {"id": 784291, "name": "图形推理", "children": [
                ...
                {"id": 784296, "name": "样式规律", "children": [
                    {"id": 784306, "name": "样式规律-加减同异"}, {"id": 784307, "name": "样式规律-黑白运算"}, {"id": 842989, "name": "样式规律-遍历"}]},
                ...
                {"id": 784298, "name": "数量规律", "children": [
                    {"id": 784309, "name": "数量规律-点"}, {"id": 784310, "name": "数量规律-线"}, {"id": 784311, "name": "数量规律-面"},
                    {"id": 784312, "name": "数量规律-角"}, {"id": 784313, "name": "数量规律-素"}, {"id": 784314, "name": "数量规律-复合"}]},
            ...
            {"id": 784292, "name": "定义判断", "children": [
                {"id": 784322, "name": "单定义", "children": [
                    ...
                    {"id": 784327, "name": "原因结果"}, {"id": 784328, "name": "单定义-其他句式"}, {"id": 792382, "name": "故事类"}, {"id": 792383, "name": "拆词"}]},
                {"id": 784323, "name": "多定义", "children": [{"id": 784329, "name": "常规问法"}, {"id": 784330, "name": "特殊问法"}]}]},
            {"id": 784293, "name": "类比推理", "children": [
                ...
                {"id": 784332, "name": "逻辑关系", "children": [
                    ...
                    {"id": 784340, "name": "逻辑关系-包容关系"}, {"id": 784341, "name": "逻辑关系-对应关系"}, {"id": 842994, "name": "逻辑关系-全同关系"}]},
            ...
            {"id": 784294, "name": "逻辑判断", "children": [
                ...
                {"id": 784343, "name": "削弱题型", "children": [
                    ...
                    {"id": 784355, "name": "削弱选非题"}, {"id": 792384, "name": "削弱论据"}, {"id": 792385, "name": "因果倒置"}, {"id": 792386, "name": "削弱-实验类"}]},
                ...
                {"id": 842995, "name": "组合排列-单题", "children": [
                    ...
                    {"id": 851143, "name": "假设"}, {"id": 851144, "name": "框架题"}, {"id": 851145, "name": "从确定信息开始推"}, {"id": 943529, "name": "组合排列-单题-其他"}]},
                {"id": 784345, "name": "原因解释"},
                {"id": 837343, "name": "真假推理", "children": [
                    {"id": 851146, "name": "只有一真/一假"}, {"id": 851147, "name": "两真两假"}, {"id": 851148, "name": "真假推理-其他"}]},
                {"id": 842996, "name": "日常结论"}, {"id": 842997, "name": "论证结构"}]}]},
        {"id": 783920, "name": "资料分析", "children": [
            {"id": 784357, "name": "文字资料"}, {"id": 784358, "name": "统计表"}, {"id": 784359, "name": "统计图"}, {"id": 784360, "name": "综合资料"},
            {"id": 784361, "name": "简单计算", "children": [{"id": 784369, "name": "直接找数"}, {"id": 784370, "name": "简单加减计算"}, {"id": 792390, "name": "排序类"}]},
            ...
            {"id": 784363, "name": "增长率", "children": [
                {"id": 784373, "name": "一般增长率"}, {"id": 784374, "name": "混合增长率"}, {"id": 792395, "name": "间隔增长率"}, {"id": 792396, "name": "年均增长率"}]},
            {"id": 784364, "name": "增长量", "children": [
                {"id": 784375, "name": "增长量计算"}, {"id": 784376, "name": "增长量比较"}, {"id": 792397, "name": "间隔增长量"}, {"id": 792398, "name": "年均增长量"}]},
            {"id": 784365, "name": "比重问题", "children": [
                {"id": 784377, "name": "现期比重"}, {"id": 784378, "name": "基期比重"}, {"id": 784379, "name": "两期比重"}, {"id": 792399, "name": "混合比重"}]},
            {"id": 784366, "name": "平均数问题", "children": [
                {"id": 784380, "name": "基期平均数"}, {"id": 784381, "name": "现期平均数"}, {"id": 784382, "name": "平均数的增长率"},
                {"id": 784383, "name": "平均数的增长量"}, {"id": 784384, "name": "两期平均数比较"}]},
            {"id": 784367, "name": "倍数与比值相关", "children": [
                {"id": 784385, "name": "基期倍数"}, {"id": 784386, "name": "现期倍数"}, {"id": 792400, "name": "比值计算"},
                {"id": 792401, "name": "比值比较"}, {"id": 792402, "name": "倍数比较"}]},
            {"id": 784368, "name": "综合分析"}]}
    ]
}
    ...
    for d1 in api_data["baseKeypointVOS"]:
        if depth == 1:
            for idx, c in enumerate(d1.get("children", []), 1):
                lines.append(f"INSERT INTO qbank_v2_knowledge_point (system_id, code, name, depth, parent_id, path, sort_order, created_by, created_time) SELECT (SELECT id FROM qbank_v2_knowledge_system WHERE code = 'xingce'), 'fenbi_{c['id']}', '{esc(c['name'])}', 1, (SELECT id FROM qbank_v2_knowledge_point WHERE code = 'fenbi_{d1['id']}' AND system_id = (SELECT id FROM qbank_v2_knowledge_system WHERE code = 'xingce')), '/fenbi_{c['id']}', {idx}, 1, NOW();")
        elif depth == 2:
            for c in d1.get("children", []):
                if "children" in c:
                    for idx, gc in enumerate(c["children"], 1):
                        lines.append(f"INSERT INTO qbank_v2_knowledge_point (system_id, code, name, depth, parent_id, path, sort_order, created_by, created_time) SELECT (SELECT id FROM qbank_v2_knowledge_system WHERE code = 'xingce'), 'fenbi_{gc['id']}', '{esc(gc['name'])}', 2, (SELECT id FROM qbank_v2_knowledge_point WHERE code = 'fenbi_{c['id']}' AND system_id = (SELECT id FROM qbank_v2_knowledge_system WHERE code = 'xingce')), '/fenbi_{gc['id']}', {idx}, 1, NOW();")
        elif depth == 3:
            for c in d1.get("children", []):
                if "children" in c:
                    for gc in c["children"]:
                        if "children" in gc:
                            for idx, ggc in enumerate(gc["children"], 1):
                                lines.append(f"INSERT INTO qbank_v2_knowledge_point (system_id, code, name, depth, parent_id, path, sort_order, created_by, created_time) SELECT (SELECT id FROM qbank_v2_knowledge_system WHERE code = 'xingce'), 'fenbi_{ggc['id']}', '{esc(ggc['name'])}', 3, (SELECT id FROM qbank_v2_knowledge_point WHERE code = 'fenbi_{gc['id']}' AND system_id = (SELECT id FROM qbank_v2_knowledge_system WHERE code = 'xingce')), '/fenbi_{ggc['id']}', {idx}, 1, NOW();")
    return "\n".join(lines)

for d in [1, 2, 3]:
    sql = gen_sql(d)
    with open(f"scripts/insert_depth_{d}.sql", "w", encoding="utf-8") as f:
        f.write(sql)
    print(f"Depth {d}: {len(sql.split(chr(10)))} statements generated")